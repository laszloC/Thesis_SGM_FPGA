...
void comp_d_map(uint8_t* img_left, uint8_t* img_right, uint8_t* disp_out, int32_t* img_cost)
{
_ssdm_op_SpecInterface(0, "s_axilite", 0, 0, "", 0, 0, "IMG_BUS", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(disp_out, "m_axi", 0, 0, "", 0, 42300, "IMG_BUS", "slave", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(img_right, "m_axi", 0, 0, "", 0, 42300, "IMG_BUS", "slave", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(img_left, "m_axi", 0, 0, "", 0, 42300, "IMG_BUS", "slave", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(img_cost, "m_axi", 0, 0, "", 0, 1269000, "COST_BUS", "slave", "", 16, 16, 16, 16, "", "");
