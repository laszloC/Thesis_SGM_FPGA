...
set Interfaces {
    s_axi_IMG_BUS {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_IMG_BUS"
        param_prefix "C_S_AXI_IMG_BUS"
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 img_left W 0x0 "Data signal of img_left" {{0 32 img_left W 0 "Bit 31 to 0 Data signal of img_left"}}} {0x18 img_right W 0x0 "Data signal of img_right" {{0 32 img_right W 0 "Bit 31 to 0 Data signal of img_right"}}} {0x20 disp_out W 0x0 "Data signal of disp_out" {{0 32 disp_out W 0 "Bit 31 to 0 Data signal of disp_out"}}} {0x28 img_cost W 0x0 "Data signal of img_cost" {{0 32 img_cost W 0 "Bit 31 to 0 Data signal of img_cost"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_IMG_BUS m_axi_IMG_BUS m_axi_COST_BUS"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_IMG_BUS {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_IMG_BUS"
        data_width "32"
        param_prefix "C_M_AXI_IMG_BUS"
        ...
        has_dependant_on "1"
        offset_slave_name "s_axi_IMG_BUS"
    ...
    m_axi_COST_BUS {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_COST_BUS"
        data_width "32"
        param_prefix "C_M_AXI_COST_BUS"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 367506352 II x}
