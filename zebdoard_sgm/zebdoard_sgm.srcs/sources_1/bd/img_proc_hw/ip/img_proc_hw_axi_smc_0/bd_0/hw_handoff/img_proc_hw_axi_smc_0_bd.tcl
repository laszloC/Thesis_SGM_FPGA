...
################################################################
# This is a generated script based on design: bd_0020
#
...
proc create_hier_cell_s04_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG004_BASE_ADDR {0x00000000FFFC0000} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEP004_RDATA_WIDTH {64} \
   CONFIG.SEP004_WDATA_WIDTH {64} \
   CONFIG.SUPPORTS_NARROW {0} \
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_SC_AR_1 [get_bd_intf_pins s03_axi2sc/M_SC_AR] [get_bd_intf_pins s03_nodes/S_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_R_1 [get_bd_intf_pins s03_nodes/S_SC_R] [get_bd_intf_pins switchboards/M03_SC_R]
  ...
  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins clk_map/S03_ACLK] [get_bd_pins s03_axi2sc/aclk] [get_bd_pins s03_entry_pipeline/aclk] [get_bd_pins s03_nodes/s_sc_clk]
  ...
  connect_bd_net -net aresetn_2 [get_bd_pins clk_map/S03_ARESETN] [get_bd_pins s03_entry_pipeline/aresetn] [get_bd_pins s03_nodes/s_sc_resetn]
  ...
  connect_bd_net -net swbd_aclk_net [get_bd_pins clk_map/swbd_aclk] [get_bd_pins m00_nodes/s_axi_aclk] [get_bd_pins s03_nodes/m_sc_clk] [get_bd_pins s04_nodes/m_sc_clk] [get_bd_pins switchboards/aclk]
  connect_bd_net -net swbd_aresetn_net [get_bd_pins clk_map/swbd_aresetn] [get_bd_pins m00_nodes/s_axi_aresetn] [get_bd_pins s03_nodes/m_sc_resetn] [get_bd_pins s04_nodes/m_sc_resetn] [get_bd_pins switchboards/aresetn]
