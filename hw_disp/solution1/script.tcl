...
config_export -description {Disparity calculator from a cost matrix} -display_name {Disparity Calculator} -format ip_catalog -library sgm -rtl vhdl -vendor Ciople -version 2.0
