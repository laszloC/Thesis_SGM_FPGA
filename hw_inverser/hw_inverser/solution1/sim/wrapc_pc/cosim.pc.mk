# ==============================================================
# File generated on Fri May 31 13:45:01 +0300 2019
...
$(ObjDir)/inv_test.cpp_pre.cpp.tb.o : inv_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling inv_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/inv.cpp_pre.cpp.tb.o : inv.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling inv.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
