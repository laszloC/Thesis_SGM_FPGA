# ==============================================================
# File generated on Fri May 31 13:44:58 +0300 2019
# Vivado(TM) HLS - High-Level Synthesis from C, C++ and SystemC v2018.3 (64-bit)
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
# IP Build 2404404 on Fri Dec  7 01:43:56 MST 2018
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved.
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/Programs/Xilinx/Vivado/2018.3/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);E:/Programs/Xilinx/Vivado/2018.3/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);E:/Programs/Xilinx/Vivado/2018.3/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/Programs/Xilinx/Vivado/2018.3/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/Programs/Xilinx/Vivado/2018.3/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "inverse_img.autotvin.dat"
	set constFileTvOut       "inverse_img.autotvout.dat"
	set constFileHdlTvIn     "inverse_img.autohdltvin.dat"
	set constFileHdlTvOut    "inverse_img.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
