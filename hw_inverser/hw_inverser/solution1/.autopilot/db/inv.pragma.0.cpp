# 1 "hw_inverser/inv.cpp"
# 1 "hw_inverser/inv.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 152 "<built-in>" 3
# 1 "<command line>" 1
...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "hw_inverser/inv.cpp" 2
# 1 "hw_inverser/inv.h" 1
...
# 2 "hw_inverser/inv.cpp" 2

void inverse_img(uint8_t img_in[(188 * 225)], uint8_t img_out[(188 * 225)])
{_ssdm_SpecArrayDimSize(img_in, 42300);_ssdm_SpecArrayDimSize(img_out, 42300);
